...
function PortfolioBase() {
    ...
    return (<>
        <div className="App-page" style={{display:'block', gap:'0em'}}>
            <p className="App-bigtext">
                Portfolio
            </p>
            <div style={{display:'block', gap:'3em', paddingBottom: '3em'}}>
                ...
                <PortfolioItem title={'TSP Visualizer'} hicon={<>
                    <div id="tsp-vis-portfolio" style={{aspectRatio:'1/1', height:'auto', display:'block'}} className="portfolioHicon"></div>
                ...
                <PortfolioItem title={'DustSDL2'} hicon={<>
                    <div id="dust-sdl-2-portfolio" style={{aspectRatio:'960/540', height:'auto'}} className="portfolioHicon"></div>
...
function PortfolioItem({title, icon, link, hicon, description}) {
    ...
    let image;
    if (icon)
        image = <><img style={{maxWidth:'100%'}} src={'/img/' + icon} /></>;
    else
        image = hicon;
