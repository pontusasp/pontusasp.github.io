...
export default function () {
    return (
        <div className={"flex flex-col gap-4 items-center sm:m-8"}>
            <div>
                <img width={323} height={323} alt="Photo of Pontus" className={"rounded-full shadow-lg shadow-violet-950/20"} src={"/img/pontusasp.jpg"}/>
            </div>
            <div
                ...
                <div className={"flex flex-col gap-4 p-4"}>
                    ...
                    <span className={"text-xl leading-relaxed"}>I am currently employed as a software developer at <a className={"font-bold"} href={"https://skry.se/"} target={"_blank"} rel="noreferrer">Skry</a>.</span>
                    ...
                    <span className={"text-xl leading-relaxed"}>If you want to check out some of the things I have been working on you can find them at my <Link className={"font-bold"} to="/portfolio">Portfolio page</Link>!</span>
                </div>
            </div>
