...
const projects = [
    {
        ...
        description: <>
            In this course I got an introduction to ray tracing, rasterizing and other techniques used in games, such as portals, bounding volumes for collision checking etc. I also made a project where I made a navier-stokes fluid dynamics simulation using C++ and SFML. Here is the <a className={"underline"} href="https://github.com/pontusasp/fluid-simulation" target="_blank">GitHub Page</a> and the <a className={"underline"} href="https://github.com/pontusasp/fluid-simulation/blob/master/blog.md" target="_blank">Development Blog</a>.
        </>,
    },
    {
        title: "Wanderful",
        ...
        description: <>
            In this course I along with a few other students created a game with inspiration taken from hotline miami.<br/>Here you can find the <Link className={"underline"} to="/kth/dh2650/blog">development blog</Link>, and the <a className={"underline"} href="https://wanderfulgame.netlify.app/" target="_blank" rel="noreferrer">project website</a>.
        </>,
    },
    {
        title: "Nightmar",
...
function CourseProject(props) {
    return (
        <div
            className={"rounded-md border-violet-900 sm:border-b-4 sm:max-w-2xl shadow-violet-950/50 bg-gradient-to-br from-violet-950/10 to-violet-900/10 p-4 shadow-lg"}>
            <div className={"flex flex-col gap-4 p-4"}>
                <span className={"text-2xl font-bold tracking-wide"}>{props.title}</span>
...
function Kth() {
    return (
        <div className={"flex flex-col gap-8 items-center my-8"}>
            <div
                className={"rounded-md border-b-4 border-violet-950 bg-gradient-to-br from-violet-950/20 to-violet-900/20 p-4 shadow-lg"}>
                <div className={"flex flex-col gap-4 p-4"}>
                    <span className={"text-2xl font-bold tracking-wide"}>KTH Royal Institute of Technology</span>
                    <span className={"text-2xl font-bold tracking-wide"}>Course Projects</span>
                    <span className={"text-xl leading-relaxed"}>Here are some course projects that I have been working on during my time as a student at KTH.</span>
                </div>
            </div>
            <CourseProjects />
        </div>
